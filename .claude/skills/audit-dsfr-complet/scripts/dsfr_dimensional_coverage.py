...
def build(root: Path, page_id: str) -> dict[str, Any]:
    ...
    result={"schema_version":1,"page":page["page"],"claim":"Cette matrice inventorie la couverture observée. Elle ne déclare aucune conformité DSFR globale.","versions":{"observed":"1.13.2 déclarée par la campagne","target":"1.15.3","exact_observed_reference_available":False,"exact_target_component_corpus_available":False},"summary":summary,"families":family_rows,"classes":class_rows,"remaining_protocols":["Référence officielle exacte 1.13.2 et artefact cible 1.15.3","Lecteurs d’écran réels","Consentement: révocation et contrôle effectif des traceurs","Modales: fond inerte, clic extérieur et scroll","Thèmes: fidélité visuelle et contrastes dans les états clair, sombre et système","Mégamenus et composants à tous les breakpoints","États hover, focus, active, disabled et erreur par variante"]}
